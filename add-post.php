                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 pb-3">
                      <div class="form-floating mb-3">
                        <select name="network" class="form-select" id="floatingSelect" aria-label="Rede Social
                    ...
                    <div class="col-md-6 pb-3">
                      <div class="form-floating mb-3">
                        <select name="type" class="form-select" id="floatingSelect" aria-label="Plano Essencial">
