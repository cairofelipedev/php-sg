...
<body>
  ...
  <aside id="sidebar" class="sidebar bg-black">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      <li class="nav-item">
        <a class="nav-link bg-black text-white border" href="index.html">
      ...
      <li class="nav-item">
        <a class="nav-link bg-black text-white border" href="index.html">
          <i class="text-white bi bi-layout-text-window-reverse"></i>
          <span>Posts</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link bg-black text-white border" href="index.html">
          <i class="text-white bi bi-bar-chart"></i>
          <span>Ranking</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link bg-black text-white border" href="index.html">
          <i class="text-white bi bi-journal-text"></i>
          <span>Material</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link bg-black text-white" href="index.html">
